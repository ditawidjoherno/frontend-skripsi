        ...
        <div className=''>
          ...
          >
            ...
            {namaStaff && namaStaff.map((staff, index) => (
              <option className="sm:text-[17px] text-[10px]" key={index} value={staff.user_id}>{staff.nama}</option>
            ))}
          </select>
        </div>
        <div>
          ...
          >
            ...
            <option className="sm:text-[17px] text-[10px]" value="Agen">Agen</option>
            ...
            <option className="sm:text-[17px] text-[10px]" value="Akuisi Satker">AKUISISI SATKER</option>
          ...
          <thead>
            <tr>
              ...
              {months.map((month, index) => (
                <th key={index} className="border border-gray-300 px-14 sm:py-4 py-2">
                  {month.charAt(0).toUpperCase() + month.slice(1)}
                </th>
              ))}
              <th className="border border-gray-300 px-14 sm:py-4 py-2">Aksi</th> {/* Kolom Aksi */}
            </tr>
          </thead>
          <tbody>
