                    ...
                    <table className="table-auto border-collapse w-full text-center overflow-x-auto">
                        <thead>
                            <tr>
                                ...
                                <th className="sm:px-14 px-7 sm:py-4 py-0">Status Prospek</th>
                            </tr>
                        </thead>
                        <tbody>
                            {filteredData.map((data, index) => (
                                <tr key={index}>
                                    ...
                                    <td>
                                    <div className={`py-1 rounded-md mx-4 text-white font-semibold ${data.statusprospek === 'Diterima' ? 'bg-green-500 ' : data.statusprospek === 'Ditolak' ? 'bg-red-500' : ''}`}>
                                        {data.statusprospek}
                                    </div>
                                        </td>
                                </tr>
