...
const Search = ({ onSearch }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex items-center sm:pr-0 pr-9 sm:ml-0 ml-7 sm:mt-0 mt-3">
            ...
            />
            <button type="submit" className="bg-[#FFE500] text-black border-1 border-black px-3 sm:py-2 py-1 rounded-r-2xl hover:bg-[#f6f0ba] focus:outline-none ">
                <IoSearchOutline size={window.innerWidth <= 768 ? 20 : 27} />
            </button>
        </form>
    );
};
