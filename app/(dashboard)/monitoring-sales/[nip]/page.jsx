...
const page = () => {
  ...
  const handleTargetClick = () => {
    window.location.href = '/target-tahunan';
  };

  // const handleSalesClick = () => {
  //   window.location.href = '/aktivitas-sales';
  // };
...

  {
    data && data.forEach((staf) => {
      const totalNilaiKpiStaf = Object.values(staf.total_nilai_kpi).reduce((total, nilai) => total + nilai, 0);
      totalNilaiKpi += totalNilaiKpiStaf;
      jumlahBulan += Object.keys(staf.total_nilai_kpi).length;
    });
  }

  const rataRataNilaiKpi = parseInt(totalNilaiKpi / jumlahBulan);
        ...
        <div className='sm:flex sm:ml-0 ml-1'>
          <div className="w-1/2 sm:flex sm:items-center sm:mt-[-10px] mt-[15px]">
            ...
            <div className="w-full sm:mt-[-40px] mt-[20px] sm:text-left text-center sm:ml-0 ml-[80px]">
              {data && (
                <>
                  <TeksProfil label="Nama Staff" value={data.nama} />
        ...
        <div className="w-full sm:pl-10 pl-[20px] flex justify-between px-9">
          <div className="flex flex-col gap-1 relative border border-gray-500 border-solid sm:border-3 border-10 sm:pr-0 pr-23 pt-[5px] sm:-mt-[90px] mt-[30px] sm:ml-0 -ml-[10px]">
            <div className="relative pr-50">
              <button className={`bg-[#F8DE22] text-black text-left transition-all transform hover:bg-[#9ebfea] sm:w-[400px] w-1/2 h-[35px] px-2 pt-30 mt-[25px] mr-[60px] rounded-r-xl font-semibold `}>
                JAN
                <text className="absolute left-[100%] top-[50%] transform -translate-y-1/2 font-semibold">{data && data[0].total_nilai_kpi.januari}%</text>
              </button>
            </div>
            <div className="relative">
              <button className="bg-[#f8c322] text-black text-left transition-all transform hover:bg-[#9ebfea] sm:w-[300px] w-[220px] h-[35px] px-2 pt-30  rounded-r-xl font-semibold">
                FEB
                <tex className="absolute left-[100%] top-[50%] transform -translate-y-1/2 font-semibold">{data && data[0].total_nilai_kpi.februari}%</tex>
              </button>
            </div>
            <div className="relative">
              <button className="bg-[#FD8D14] text-black text-left transition-all transform hover:bg-[#9ebfea] w-[187px] h-[35px] px-2 pt-30  rounded-r-xl font-semibold">
                MAR
                <text className="absolute left-[100%] top-[50%] transform -translate-y-1/2 font-semibold">{data && data[0].total_nilai_kpi.maret}%</text>
              </button>
            </div>
            <div className="relative">
              <button className="bg-[#E3651D] text-black text-left transition-all transform hover:bg-[#9ebfea] w-[93px] h-[35px] px-2 pt-30  rounded-r-xl font-semibold">
                APR
                <text className="absolute left-[100%] top-[50%] transform -translate-y-1/2 font-semibold">{data && data[0].total_nilai_kpi.april}%</text>
              </button>
            </div>
            <div className="relative">
              <button className="bg-[#BE3144] text-black text-left transition-all transform hover:bg-[#9ebfea] w-[168px] h-[35px] px-2 pt-30  rounded-r-xl font-semibold">
                MEI
                <text className="absolute left-[100%] top-[50%] transform -translate-y-1/2 font-semibold">{data && data[0].total_nilai_kpi.mei}%</text>
              </button>
            </div>
            <div className="relative">
              <button className="bg-[#872341] text-black text-left transition-all transform hover:bg-[#9ebfea] sm:w-[330px] w-[50px] h-[35px] px-2 pt-30 rounded-r-xl font-semibold">
                JUN
                <text className="absolute left-[100%] top-[50%] transform -translate-y-1/2 font-semibold">{data && data[0].total_nilai_kpi.juni}%</text>
              </button>
            </div>
            <div className="relative">
              <button className="bg-[#631c7f] text-black text-left transition-all transform hover:bg-[#9ebfea] w-[70px] h-[35px] px-2 pt-30 rounded-r-xl font-semibold">
                JUL
                <text className="absolute left-[100%] top-[50%] transform -translate-y-1/2 font-semibold">{data && data[0].total_nilai_kpi.juli}%</text>
              </button>
            </div>
            <div className="relative">
              <button className="bg-[#24366d] text-black text-left transition-all transform hover:bg-[#9ebfea] w-[155px] h-[35px] px-2 pt-30 rounded-r-xl font-semibold">
                AGS
                <text className="absolute left-[100%] top-[50%] transform -translate-y-1/2 font-semibold">{data && data[0].total_nilai_kpi.agustus}%</text>
              </button>
            </div>
            <div className="relative">
              <button className="bg-[#315888] text-black text-left transition-all transform hover:bg-[#9ebfea] w-[270px] h-[35px] px-2 pt-30 rounded-r-xl font-semibold">
                SEP
                <text className="absolute left-[100%] top-[50%] transform -translate-y-1/2 font-semibold">{data && data[0].total_nilai_kpi.september}%</text>
              </button>
            </div>
            <div className="relative">
              <button className="bg-[#4b6bd6] text-black text-left transition-all transform hover:bg-[#9ebfea] w-[155px] h-[35px] px-2 pt-30 rounded-r-xl font-semibold">
                OKT
                <text className="absolute left-[100%] top-[50%] transform -translate-y-1/2 font-semibold">{data && data[0].total_nilai_kpi.oktober}%</text>
              </button>
            </div>
            <div className="relative">
              <button className="bg-[#488a48] text-black text-left transition-all transform hover:bg-[#9ebfea] w-[70px] h-[35px] px-2 pt-30 rounded-r-xl font-semibold">
                NOV
                <text className="absolute left-[100%] top-[50%] transform -translate-y-1/2 font-semibold">{data && data[0].total_nilai_kpi.november}%</text>
              </button>
            </div>
            <div className="relative">
              <button className="bg-[#62c162] text-black text-left transition-all transform hover:bg-[#9ebfea] w-[210px] h-[35px] px-2 pt-30 rounded-r-xl font-semibold">
                DES
                <text className="absolute left-[100%] top-[50%] transform -translate-y-1/2 font-semibold">{data && data[0].total_nilai_kpi.desember}%</text>
              </button>
            </div>
          </div>
        </div>
