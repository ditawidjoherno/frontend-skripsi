    ...
    <div className={`bg-[#EAEAEA] h-full flex flex-col items-center sm:pt-[75px] pt-[60px] sm:pr-4 pr-3 sm:ml-20 ml-10`}>
      ...
      <div className="bg-white rounded-2xl h-auto mb-6 sm:ml-5 ml-3 w-full sm:pt-5 pt-4 sm:pr-0 pr-19">
        ...
        <div className="flex flex-col mt-[15px] sm:mr-[85px] mr-[70px]">
          ...
          <button className="bg-[#d9d9d9] transition-all transform hover:bg-[#a9a7a7] sm:w-[220px] w-[200px] h-[35px] ml-auto px-10 pt-30 mt-[25px] font-medium sm:mr-20 mr-middle shadow-md"onClick={handleSalesClick}>
            Aktivitas Sales
          </button>
        </div>
