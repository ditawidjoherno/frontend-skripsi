...
const BoxProfil = ({ nama, image, nip, onClick }) => {
    return (
        <div className="sm:h-[150px] h-[180px] flex sm:gap-8 gap-1 items-center py-9 px-10 bg-white w-auto min-w-[40%] rounded-xl sm:ml-3 ml-1 pt-9 cursor-pointer" onClick={onClick} >
